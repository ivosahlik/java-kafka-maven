...
public class Store extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Store(java.lang.Integer id, Address address) {
    this.id = id;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: address = (Address)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public static Store.Builder newBuilder() {
   ...
   * @return A new Store RecordBuilder
   */
  public static Store.Builder newBuilder(Store.Builder other) {
    if (other == null) {
      return new Store.Builder();
    } else {
      return new Store.Builder(other);
    }
  }
   ...
   * @return A new Store RecordBuilder
   */
  public static Store.Builder newBuilder(Store other) {
    if (other == null) {
      return new Store.Builder();
    } else {
      return new Store.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Store>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Store.Builder other) {
      super(other);
    ...
    /**
      ...
      * @return This builder.
      */
    public Store.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Store.Builder setAddress(Address value) {
     ...
     * @return This builder.
     */
    public Store.Builder setAddressBuilder(Address.Builder value) {
      clearAddress();
    ...
    /**
      ...
      * @return This builder.
      */
    public Store.Builder clearAddress() {
      address = null;
      addressBuilder = null;
    ...
    public Store build() {
      try {
        ...
        if (addressBuilder != null) {
          ...
          record.address = fieldSetFlags()[1] ? this.address : (Address) defaultValue(fields()[1]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
