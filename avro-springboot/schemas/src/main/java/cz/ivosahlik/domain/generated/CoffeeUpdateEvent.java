...
public class CoffeeUpdateEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CoffeeUpdateEvent\",\"namespace\":\"cz.ivosahlik.domain.generated\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"status\",\"type\":{\"type\":\"enum\",\"name\":\"OrderStatus\",\"symbols\":[\"PROCESSING\",\"READY_FOR_PICK_UP\"]}}]}");
...
static {
   ...
   */
  public CoffeeUpdateEvent(java.util.UUID id, OrderStatus status) {
    this.id = id;
    this.status = status;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: status = (OrderStatus)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public static CoffeeUpdateEvent.Builder newBuilder() {
    return new CoffeeUpdateEvent.Builder();
  }
   ...
   * @return A new CoffeeUpdateEvent RecordBuilder
   */
  public static CoffeeUpdateEvent.Builder newBuilder(CoffeeUpdateEvent.Builder other) {
    if (other == null) {
      return new CoffeeUpdateEvent.Builder();
    } else {
      return new CoffeeUpdateEvent.Builder(other);
    }
  }
   ...
   * @return A new CoffeeUpdateEvent RecordBuilder
   */
  public static CoffeeUpdateEvent.Builder newBuilder(CoffeeUpdateEvent other) {
    if (other == null) {
      return new CoffeeUpdateEvent.Builder();
    } else {
      return new CoffeeUpdateEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CoffeeUpdateEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(CoffeeUpdateEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(CoffeeUpdateEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeUpdateEvent.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeUpdateEvent.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeUpdateEvent.Builder setStatus(OrderStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeUpdateEvent.Builder clearStatus() {
      status = null;
    ...
    public CoffeeUpdateEvent build() {
      try {
        ...
        record.status = fieldSetFlags()[1] ? this.status : (OrderStatus) defaultValue(fields()[1]);
        return record;
