...
public class Store extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public cz.ivosahlik.domain.generated.Address address;
   ...
   */
  public Store(java.lang.Integer id, cz.ivosahlik.domain.generated.Address address) {
    this.id = id;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: address = (cz.ivosahlik.domain.generated.Address)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public cz.ivosahlik.domain.generated.Address getAddress() {
    return address;
  }
   ...
   * @param value the value to set.
   */
  public void setAddress(cz.ivosahlik.domain.generated.Address value) {
    this.address = value;
  }
   ...
   */
  public static cz.ivosahlik.domain.generated.Store.Builder newBuilder() {
    return new cz.ivosahlik.domain.generated.Store.Builder();
  }
   ...
   * @return A new Store RecordBuilder
   */
  public static cz.ivosahlik.domain.generated.Store.Builder newBuilder(cz.ivosahlik.domain.generated.Store.Builder other) {
    if (other == null) {
      return new cz.ivosahlik.domain.generated.Store.Builder();
    } else {
      return new cz.ivosahlik.domain.generated.Store.Builder(other);
    }
  }
   ...
   * @return A new Store RecordBuilder
   */
  public static cz.ivosahlik.domain.generated.Store.Builder newBuilder(cz.ivosahlik.domain.generated.Store other) {
    if (other == null) {
      return new cz.ivosahlik.domain.generated.Store.Builder();
    } else {
      return new cz.ivosahlik.domain.generated.Store.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Store>
    ...
    private int id;
    private cz.ivosahlik.domain.generated.Address address;
    private cz.ivosahlik.domain.generated.Address.Builder addressBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(cz.ivosahlik.domain.generated.Store.Builder other) {
      super(other);
      ...
      if (other.hasAddressBuilder()) {
        this.addressBuilder = cz.ivosahlik.domain.generated.Address.newBuilder(other.getAddressBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(cz.ivosahlik.domain.generated.Store other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public cz.ivosahlik.domain.generated.Store.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public cz.ivosahlik.domain.generated.Store.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public cz.ivosahlik.domain.generated.Store.Builder setAddress(cz.ivosahlik.domain.generated.Address value) {
     ...
     * @return This builder.
     */
    public cz.ivosahlik.domain.generated.Address.Builder getAddressBuilder() {
      if (addressBuilder == null) {
        if (hasAddress()) {
          setAddressBuilder(cz.ivosahlik.domain.generated.Address.newBuilder(address));
        } else {
          setAddressBuilder(cz.ivosahlik.domain.generated.Address.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public cz.ivosahlik.domain.generated.Store.Builder setAddressBuilder(cz.ivosahlik.domain.generated.Address.Builder value) {
      clearAddress();
    ...
    /**
      ...
      * @return This builder.
      */
    public cz.ivosahlik.domain.generated.Store.Builder clearAddress() {
      address = null;
      addressBuilder = null;
    ...
    public Store build() {
      try {
        ...
        if (addressBuilder != null) {
          ...
          record.address = fieldSetFlags()[1] ? this.address : (cz.ivosahlik.domain.generated.Address) defaultValue(fields()[1]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.address == null) {
        this.address = new cz.ivosahlik.domain.generated.Address();
      }
