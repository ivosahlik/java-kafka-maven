...
static {
  ...
  @Deprecated public OrderId id;
  @Deprecated public java.lang.CharSequence name;
  /** Optional field represents the nick name for the user */
  @Deprecated public java.lang.CharSequence nickName;
  @Deprecated public Store store;
  @Deprecated public java.util.List<OrderLineItem> orderLineItems;
   ...
   */
  public CoffeeOrder(OrderId id, java.lang.CharSequence name, java.lang.CharSequence nickName, Store store, java.util.List<OrderLineItem> orderLineItems, java.time.Instant ordered_time, java.lang.CharSequence status) {
    this.id = id;
    this.name = name;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: id = (OrderId)value$; break;
    case 1: name = (java.lang.CharSequence)value$; break;
    case 2: nickName = (java.lang.CharSequence)value$; break;
    case 3: store = (Store)value$; break;
    case 4: orderLineItems = (java.util.List<OrderLineItem>)value$; break;
   ...
   */
  public void setId(OrderId value) {
    this.id = value;
  }
   ...
   * @param value the value to set.
   */
  public void setOrderLineItems(java.util.List<OrderLineItem> value) {
   ...
   */
  public static CoffeeOrder.Builder newBuilder() {
    return new CoffeeOrder.Builder();
  }
   ...
   * @return A new CoffeeOrder RecordBuilder
   */
  public static CoffeeOrder.Builder newBuilder(CoffeeOrder.Builder other) {
    if (other == null) {
      return new CoffeeOrder.Builder();
    } else {
      return new CoffeeOrder.Builder(other);
    }
  }
   ...
   * @return A new CoffeeOrder RecordBuilder
   */
  public static CoffeeOrder.Builder newBuilder(CoffeeOrder other) {
    if (other == null) {
      return new CoffeeOrder.Builder();
    } else {
      return new CoffeeOrder.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CoffeeOrder>
    ...
    private OrderId id;
    private OrderId.Builder idBuilder;
    private java.lang.CharSequence name;
    /** Optional field represents the nick name for the user */
    private java.lang.CharSequence nickName;
    private Store store;
    private Store.Builder storeBuilder;
    private java.util.List<OrderLineItem> orderLineItems;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(CoffeeOrder.Builder other) {
      super(other);
      ...
      if (other.hasIdBuilder()) {
        this.idBuilder = OrderId.newBuilder(other.getIdBuilder());
      }
      ...
      if (other.hasStoreBuilder()) {
        this.storeBuilder = Store.newBuilder(other.getStoreBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(CoffeeOrder other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeOrder.Builder setId(OrderId value) {
     ...
     * @return This builder.
     */
    public OrderId.Builder getIdBuilder() {
      if (idBuilder == null) {
        if (hasId()) {
          setIdBuilder(OrderId.newBuilder(id));
        } else {
          setIdBuilder(OrderId.newBuilder());
        }
      }
      return idBuilder;
    }
     ...
     * @return This builder.
     */
    public CoffeeOrder.Builder setIdBuilder(OrderId.Builder value) {
      clearId();
      idBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeOrder.Builder clearId() {
      id = null;
      idBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeOrder.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeOrder.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeOrder.Builder setNickName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeOrder.Builder clearNickName() {
      nickName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeOrder.Builder setStore(Store value) {
    ...
    public Store.Builder getStoreBuilder() {
      if (storeBuilder == null) {
        if (hasStore()) {
          setStoreBuilder(Store.newBuilder(store));
        } else {
          setStoreBuilder(Store.newBuilder());
        }
      }
      return storeBuilder;
    }
     ...
     * @return This builder.
     */
    public CoffeeOrder.Builder setStoreBuilder(Store.Builder value) {
      clearStore();
      storeBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeOrder.Builder clearStore() {
      store = null;
      storeBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeOrder.Builder setOrderLineItems(java.util.List<OrderLineItem> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeOrder.Builder clearOrderLineItems() {
      orderLineItems = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeOrder.Builder setOrderedTime(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeOrder.Builder clearOrderedTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeOrder.Builder setStatus(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeOrder.Builder clearStatus() {
      status = null;
    ...
    public CoffeeOrder build() {
      try {
        ...
        if (idBuilder != null) {
          ...
          record.id = fieldSetFlags()[0] ? this.id : (OrderId) defaultValue(fields()[0]);
        }
        ...
        if (storeBuilder != null) {
          ...
          record.store = fieldSetFlags()[3] ? this.store : (Store) defaultValue(fields()[3]);
        }
        record.orderLineItems = fieldSetFlags()[4] ? this.orderLineItems : (java.util.List<OrderLineItem>) defaultValue(fields()[4]);
