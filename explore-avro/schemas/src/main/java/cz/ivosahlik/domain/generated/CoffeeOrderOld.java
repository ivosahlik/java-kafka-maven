...
static {
   ...
   */
  public CoffeeOrderOld(java.lang.Long id, java.lang.CharSequence name, Store store, java.util.List<OrderLineItem> orderLineItems) {
    this.id = id;
    this.name = name;
    this.store = store;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: store = (Store)value$; break;
    case 3: orderLineItems = (java.util.List<OrderLineItem>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public static CoffeeOrderOld.Builder newBuilder() {
    return new CoffeeOrderOld.Builder();
  }
   ...
   * @return A new CoffeeOrderOld RecordBuilder
   */
  public static CoffeeOrderOld.Builder newBuilder(CoffeeOrderOld.Builder other) {
    if (other == null) {
      return new CoffeeOrderOld.Builder();
    } else {
      return new CoffeeOrderOld.Builder(other);
    }
  }
   ...
   * @return A new CoffeeOrderOld RecordBuilder
   */
  public static CoffeeOrderOld.Builder newBuilder(CoffeeOrderOld other) {
    if (other == null) {
      return new CoffeeOrderOld.Builder();
    } else {
      return new CoffeeOrderOld.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CoffeeOrderOld>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(CoffeeOrderOld.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(CoffeeOrderOld other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeOrderOld.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeOrderOld.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeOrderOld.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeOrderOld.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeOrderOld.Builder setStore(Store value) {
     ...
     * @return This builder.
     */
    public CoffeeOrderOld.Builder setStoreBuilder(Store.Builder value) {
      clearStore();
      storeBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeOrderOld.Builder clearStore() {
      store = null;
      storeBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeOrderOld.Builder setOrderLineItems(java.util.List<OrderLineItem> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public CoffeeOrderOld.Builder clearOrderLineItems() {
      orderLineItems = null;
    ...
    public CoffeeOrderOld build() {
      try {
        ...
        if (storeBuilder != null) {
          ...
          record.store = fieldSetFlags()[2] ? this.store : (Store) defaultValue(fields()[2]);
        }
        record.orderLineItems = fieldSetFlags()[3] ? this.orderLineItems : (java.util.List<OrderLineItem>) defaultValue(fields()[3]);
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
