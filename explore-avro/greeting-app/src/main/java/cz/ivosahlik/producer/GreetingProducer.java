...
import cz.ivosahlik.Greeting;
import cz.ivosahlik.consumer.GreetingConsumer;
...
public class GreetingProducer {
    ...
    private static Greeting buildGreeting(String message) {
        ...
        return Greeting.newBuilder()
                ...
                .setCreatedDateTimeLocal(Instant.now()) // LocalDateTime
                .setCreatedDateTime(Instant.now())
                .setCreatedDate(LocalDate.now())
                .setCost(BigDecimal.valueOf(3.999))
                .build();
    }
