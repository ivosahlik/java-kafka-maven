...
public class Greeting extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2696629256119977200L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Greeting\",\"namespace\":\"cz.ivosahlik\",\"fields\":[{\"name\":\"greeting\",\"type\":\"string\"},{\"name\":\"id\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"createdDateTimeLocal\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}},{\"name\":\"createdDateTime\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}},{\"name\":\"createdDate\",\"type\":{\"type\":\"int\",\"logicalType\":\"date\"}},{\"name\":\"cost\",\"type\":{\"type\":\"bytes\",\"logicalType\":\"decimal\",\"precision\":4,\"scale\":3}}]}");
...
static {
  ...
  @Deprecated public java.time.Instant createdDateTimeLocal;
   ...
   */
  public Greeting(java.lang.CharSequence greeting, java.util.UUID id, java.time.Instant createdDateTimeLocal, java.time.Instant createdDateTime, java.time.LocalDate createdDate, java.math.BigDecimal cost) {
    this.greeting = greeting;
    this.id = id;
    this.createdDateTimeLocal = createdDateTimeLocal.truncatedTo(java.time.temporal.ChronoUnit.MILLIS);
  ...
  public java.lang.Object get(int field$) {
    ...
    case 1: return id;
    case 2: return createdDateTimeLocal;
    case 3: return createdDateTime;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: createdDateTimeLocal = (java.time.Instant)value$; break;
    case 3: createdDateTime = (java.time.Instant)value$; break;
    case 4: createdDate = (java.time.LocalDate)value$; break;
    case 5: cost = (java.math.BigDecimal)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.time.Instant getCreatedDateTimeLocal() {
   ...
   * @param value the value to set.
   */
  public void setCreatedDateTimeLocal(java.time.Instant value) {
    this.createdDateTimeLocal = value.truncatedTo(java.time.temporal.ChronoUnit.MILLIS);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Greeting>
    ...
    private java.time.Instant createdDateTimeLocal;
    ...
    private Builder(Greeting.Builder other) {
      ...
      if (isValidValue(fields()[2], other.createdDateTimeLocal)) {
        this.createdDateTimeLocal = data().deepCopy(fields()[2].schema(), other.createdDateTimeLocal);
        fieldSetFlags()[2] = other.fieldSetFlags()[2];
      }
      if (isValidValue(fields()[3], other.createdDateTime)) {
        this.createdDateTime = data().deepCopy(fields()[3].schema(), other.createdDateTime);
    ...
    /**
      ...
      * @return This builder.
      */
    public Greeting.Builder setGreeting(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Greeting.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Greeting.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Greeting.Builder setCreatedDateTimeLocal(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Greeting.Builder clearCreatedDateTimeLocal() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Greeting.Builder setCreatedDateTime(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Greeting.Builder clearCreatedDateTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Greeting.Builder setCreatedDate(java.time.LocalDate value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Greeting.Builder clearCreatedDate() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Greeting.Builder setCost(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Greeting.Builder clearCost() {
      cost = null;
    ...
    public Greeting build() {
      try {
        ...
        record.createdDateTimeLocal = fieldSetFlags()[2] ? this.createdDateTimeLocal : (java.time.Instant) defaultValue(fields()[2]);
        record.createdDateTime = fieldSetFlags()[3] ? this.createdDateTime : (java.time.Instant) defaultValue(fields()[3]);
        record.createdDate = fieldSetFlags()[4] ? this.createdDate : (java.time.LocalDate) defaultValue(fields()[4]);
        record.cost = fieldSetFlags()[5] ? this.cost : (java.math.BigDecimal) defaultValue(fields()[5]);
        return record;
